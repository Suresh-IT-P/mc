...
def fetch_products():
    ...
    all_products = []
    while True:
        url = f"https://axorhelmets.com/products.json?limit=250&page={page}"
...
def main():
    ...
    axor_raw = fetch_products()
    print(f"Fetched {len(axor_raw)} raw products from Axor.")
    ...
    for p in axor_raw:
        ...
        if not desc:
            desc = f"Premium {title} from Axor."
    ...
    print("js/products.js updated successfully.")
